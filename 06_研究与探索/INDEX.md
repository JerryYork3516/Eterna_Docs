...
- [AI 情报自动化系统 Stage 1.6 Analysis and Curation Rules](AI_情报/Stage1/Analysis_Curation_Rules_v0.1.md)（FROZEN，分析、筛选与摘要规则）
...
- `每日AI资讯/**` 是 `AGENTS.md` 明确批准的自动生成研究运行产物目录；这里只登记目录级治理，不为每日新增日报或同日报 Revision 创建逐文件索引项。
- 该例外不适用于 `06_研究与探索` 下的其他文件或目录；其他正式文档继续遵守仓库索引与变更记录规则。
